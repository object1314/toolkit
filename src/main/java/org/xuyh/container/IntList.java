...
public interface IntList extends Iterable<Integer> {
     ...
     * @throws IndexOutOfBoundsException when the index is out
     */
    IntList set(int index, int value);
     ...
     */
    IntList addAll(Collection<? extends Number> c);
     ...
     *                                   <code>null</code>
     */
    IntList insertAll(int index, int... values);
     ...
     *
     * @param index index at which the specified element is to be inserted
     * @param c     elements to be inserted but in collection way
     * @return this
     * @throws IndexOutOfBoundsException when the index is out
     ...
     *                                   null
     */
    IntList insertAll(int index, Collection<? extends Number> c);
     ...
     * @throws NullPointerException      when the input list is <code>null</code>
     */
    IntList insertAll(int index, IntList o);
     ...
     */
    IntList delIf(IntPredicate filter);
     ...
     *
     * @return a list in integer type containing all the elements in this list in
     * proper sequence
     */
    List<Integer> toRefList();
     ...
     */
    IntIterator intIterator(int index);
