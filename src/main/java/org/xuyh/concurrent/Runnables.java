...
public final class Runnables {
    ...
    /**
     * Execute a function in asynchronous way. This function can be canceled before
    ...
    /**
     * Execute a function in asynchronous way after specified delay milliseconds.
     * This function can be canceled before it runs and can also wait the task
     * finishes.
     *
     * @param task        the {@link Runnable} to run
    ...
    public static Runnable combine(Runnable run1, Runnable run2) {
        if (null == run1 || null == run2) throw new NullPointerException();
        Runnable[] runs1 = null;
        Runnable[] runs2 = null;
        int size = 0;
